...
const items = [
    {
        key: "1",
        picture: <img src={mockupfinalr1} alt="final mockup" height="100%" width="100%"/>,
    ...
    {
        key: "2",
        picture: <img src={mockupfinalr2} alt="final mockup" height="68%" width="68%"/>,
    ...
    {
        key: "3",
        picture: <img src={mockupfinalr3} alt="final mockup" height="100%" width="100%"/>,
